window.addEventListener('load', () => {
 ...
 const task_situation_div = document.createElement("button");
 task_situation_div.classList.add("situation")
  task_situation_div.innerHTML = "satisfy"
  task_actions_div.appendChild(task_situation_div)
...
task_situation_div.addEventListener("click", function () {
 const isSatisfied = confirm("Are you satisfied?");

 // Check user satisfaction and update the button content accordingly
 if (isSatisfied) {
  task_situation_div.innerHTML = "😊 👍👍"; // Display a like emoji
 } else {
  task_situation_div.innerHTML = "😞👎👎"; // Display a dislike emoji
 }
});
